...
data:
  ...
  code: "when not declared ATCODER_PARTICULAR_MOD_CONVOLUTION:\n  const ATCODER_PARTICULAR_MOD_CONVOLUTION*\
    ...
    \  type ParticularModConvolution* = object\n    discard\n  type ParticularModFFTType[T:StaticModInt]\
    \ = seq[T]\n  proc fft*[T:StaticModInt](t:typedesc[ParticularModConvolution],\
    \ a:seq[T]):ParticularModFFTType[T] {.inline.} =\n    result = a\n    butterfly(result)\n\
    \  proc inplace_partial_dot*[T](t:typedesc[ParticularModConvolution], a:var ParticularModFFTType[T],\
    \ b:ParticularModFFTType[T], p:Slice[int]) =\n    for i in p:\n      a[i] *= b[i]\n\
    ...
    \ ifft*[T](t:typedesc[ParticularModConvolution], a:ParticularModFFTType[T]):seq[T]\
