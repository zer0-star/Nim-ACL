...
data:
  ...
  code: "when not declared ATCODER_GRAPH_TEMPLATE_HPP:\n  const ATCODER_GRAPH_TEMPLATE_HPP*\
    ...
    \ T:typedesc = int, U:typedesc = int):Graph[T, U, SEQ] =\n    return Graph[T,\
    \ int, SEQ](len:n, adj:newSeqWith(n, newSeq[Edge[T, U]]()))\n  proc initGraph*[U](n:int,\
    \ id:proc(u:U):int, T:typedesc = int):Graph[T, U, SEQ] =\n    return Graph[T,\
    \ U, SEQ](len:n, adj:newSeqWith(n,newSeq[Edge[T, U]]()), id:id)\n  proc initGraph*[T,\
    \ U](n:int, id:proc(u:U):int, adj:proc(u:U):seq[(U, T)]):Graph[T, U, PROC] =\n\
    \    return Graph[T, U, PROC](len:n, adj:adj, id:id)\n  proc initGraph*[T, U](n:int,\
    \ id:proc(u:U):int, adj_iter:iterator(u:U):(U, T)):Graph[T, U, ITER] =\n    return\
    \ Graph[T, U, ITER](len:n, adj_iter:adj_iter, id:id)\n\n  template `[]`*[G:Graph](g:G,\
    \ u:G.U):auto =\n    when G.adjType is SEQ:\n      when u is int: g.adj[u]\n \
    \     else: g.adj[g.id(u)]\n    else:\n      g.adj(u)\n\n  proc addBiEdge*[T,\
    \ U](g:var Graph[T, U, SEQ],e:Edge[T, U]):void =\n#    var e_rev = initEdge[T](e.src,\
    \ e.dst, e.weight, e.rev)\n    var e_rev = e\n    swap(e_rev.src, e_rev.dst)\n\
    \    let (r, s) = (g[e.src].len, g[e.dst].len)\n    g[e.src].add(e)\n    g[e.dst].add(e_rev)\n\
    \    g[e.src][^1].rev = s\n    g[e.dst][^1].rev = r\n\n  proc addBiEdge*[T, U](g:var\
    \ Graph[T, U, SEQ],src,dst:U,weight:T = 1):void =\n    g.addBiEdge(initEdge(src,\
    \ dst, weight))\n\n  proc addEdge*[T, U](g:var Graph[T, U, SEQ], e:Edge[T, U])\
    \ = g[e.src].add(e)\n  proc addEdge*[T, U](g:var Graph[T, U, SEQ], src, dst:U,\
    ...
    \ b[i], c[i])\n  proc initUndirectedGraph*[U](n:int, a,b:seq[U]):Graph[int, U,\
    \ SEQ] =\n    result = initGraph[int](n, U)\n    for i in 0..<a.len: result.addBiEdge(a[i],\
    \ b[i])\n  proc initDirectedGraph*[T, U](n:int, a,b:seq[U],c:seq[T]):Graph[T,\
    ...
    \    else: g.id(u)\n\n  iterator adj*[T, U](g:Graph[T, U, ITER], u:U):tuple[dst:U,\
