...
| sortedsetmap は、順序付き集合・順序付き写像を提供します。 | [sorted_set_map](./extra/structure/sorted_set_map.html) | `import atcoder/extra/structure/sorted_set_map` | `SortedTree, SortedSetType, empty, check_tree, write` |
...
| このページは自動生成された下書きです。 | [bitset](./extra/other/bitset.html) | `import atcoder/extra/other/bitset` | `BitSet, initBitSet1, init1, getSize, DynamicBitSet` |
| このページは自動生成された下書きです。 | [bitutils](./extra/other/bitutils.html) | `import atcoder/extra/other/bitutils` | `seqToBits, and, or, xor, iterBits` |
