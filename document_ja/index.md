...
- [dsu](dsu.md)
- [dynamic_lazysegtree](dynamic_lazysegtree.md)
- [dynamic_segtree](dynamic_segtree.md)
...
- [convex_hull_trick_add_monotone](extra/structure/convex_hull_trick_add_monotone.md)
- [generalized_slope_trick](extra/structure/generalized_slope_trick.md)
- [li_chao_tree](extra/structure/li_chao_tree.md)
...
- [segtree_2d](extra/structure/segtree_2d.md)
- [set_map](extra/structure/set_map.md)
...
- [sorted_set_map](extra/structure/sorted_set_map.md)
- [splay_tree](extra/structure/splay_tree.md)
- [succinct_indexable_dictionary](extra/structure/succinct_indexable_dictionary.md)
- [trie](extra/structure/trie.md)
- [universal_segtree](extra/structure/universal_segtree.md)
- [wavelet_matrix](extra/structure/wavelet_matrix.md)
- [weighted_union_find](extra/structure/weighted_union_find.md)
