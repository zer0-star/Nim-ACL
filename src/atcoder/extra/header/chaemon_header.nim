when not declared ATCODER_CHAEMON_HEADER_HPP:
  ...
  import std/algorithm as algorithm_lib, std/sequtils as sequtils_lib, std/tables as tables_lib, std/macros as macros_lib, std/math as math_lib, std/sets as sets_lib, std/strutils as strutils_lib, std/strformat as strformat_lib
