when not declared ATCODER_EXTRA_FORWARD_COMPATIBILITY_INTERNAL_UNDERSCORED_CALLS_HPP:
  const ATCODER_EXTRA_FORWARD_COMPATIBILITY_INTERNAL_UNDERSCORED_CALLS_HPP* = 1
  import macros
