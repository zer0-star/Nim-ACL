...
data:
  ...
  code: "when not declared ATCODER_NTT_HPP:\n  const ATCODER_NTT_HPP* = 1\n  import\
    ...
    \ =\n    dot(get_fft_type(T), a, b)\n  proc inplace_partial_dot*(a:var auto, b:auto,\
    \ p:Slice[int], T:typedesc[FiniteFieldElem]) =\n    inplace_partial_dot(get_fft_type(T),\
  ...
  - verify/extra/math/pow_of_formal_power_series_test.nim
documentation_of: atcoder/extra/math/ntt.nim
layout: document
redirect_from:
- /library/atcoder/extra/math/ntt.nim
- /library/atcoder/extra/math/ntt.nim.html
