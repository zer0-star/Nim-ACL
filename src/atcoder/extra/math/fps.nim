## Convenience facade for modint-based formal power series.
##
## This module keeps the existing `formal_power_series` module compatible,
## while providing a shorter competitive-programming entry point:
##
##   useFPS(mint{x}, F, prec = 100)
##   useFPSDecl(H = mint{z}, prec = 100)
##
## The facade imports/exports NTT, formal_power_series, and
## formal_power_series_sqrt by default.  Constructors generated by `useFPS`
## resize to the declared default precision when the length is omitted.
##
## If you need the old minimal/generic import behavior, import
## `atcoder/extra/math/formal_power_series` directly.
